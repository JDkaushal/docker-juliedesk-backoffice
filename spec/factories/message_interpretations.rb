  ...
  factory :message_interpretation do
    ...
    trait :main_classif do
      ...
      before(:create) do |message_interpretation, evaluator|
        puts message_interpretation.inspect
        puts '*' * 50
        puts message_interpretation.raw_response
