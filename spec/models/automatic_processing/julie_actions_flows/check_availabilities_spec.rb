...
describe AutomaticProcessing::JulieActionsFlows::CheckAvailabilities do
  ...
  subject(:flow) { AutomaticProcessing::JulieActionsFlows::CheckAvailabilities.new(julie_action) }
  ...
  describe 'should_ask_location?' do
    ...
    context 'for skype with ask interlocutor behaviour (skype id is available)' do
      ...
      let(:main_message_interpretation) { FactoryGirl.create(:main_classification, detected_classification: 'ask_availabilities', detected_appointment_nature: 'skype', contacts_infos: [{"owner"=>"john.bernard@grabou.fr", "text"=>"john.doe", "tag"=>"SKYPE", "value"=>""}]) }
    ...
    context 'for call with ask interlocutor behaviour (landline is available)' do
      ...
      let(:main_message_interpretation) { FactoryGirl.create(:main_classification, detected_classification: 'ask_availabilities', detected_appointment_nature: 'call', contacts_infos: [{"owner"=>"john.bernard@grabou.fr", "text"=>"01333333", "tag"=>"PHONE", "value"=>"landline"}]) }
    ...
    context 'for call with ask interlocutor behaviour (mobile is available)' do
      ...
      let(:main_message_interpretation) { FactoryGirl.create(:main_classification, detected_classification: 'ask_availabilities', detected_appointment_nature: 'call', contacts_infos: [{"owner"=>"john.bernard@grabou.fr", "text"=>"06333333", "tag"=>"PHONE", "value"=>"mobile"}]) }
  ...
  describe 'trigger' do
    before(:each) do
      expect(flow).to receive(:ask_ai_verify_dates).and_return({
        date_to_book: DateTime.parse("2018-03-13T14:30:00"),
        meeting_rooms_to_book: ['room1@email.com', 'room2@email.com'],
        timezone: 'Europe/Paris'
      })
    end
    ...
    it 'should trigger the correct actions' do
      ...
      expect(flow).to receive(:get_invitations_sent_template).with(
          {:client_names=>["Monsieur Thread Owner"], :timezones=>["Europe/Paris"], :locale=>"en", :is_virtual=>false, :attendees=>[{"account_email"=>nil, "accountEmail"=>nil, "email"=>"threadowner@owner.fr", "fullName"=>"Thread Owner", "firstName"=>"Thread", "lastName"=>"Owner", "usageName"=>"Monsieur Thread Owner", "gender"=>"M", "timezone"=>"Europe/Paris", "company"=>"Owner Corp", "landline"=>nil, "mobile"=>nil, "skypeId"=>nil, "isPresent"=>true, "status"=>"present", "isClient"=>true, "assisted"=>nil, "isAssistant"=>nil, "isThreadOwner"=>true}, {"account_email"=>nil, "accountEmail"=>nil, "email"=>"john.bernard@grabou.fr", "fullName"=>"John Bernard", "firstName"=>"John", "lastName"=>"Bernard", "usageName"=>"Monsieur John Bernard", "gender"=>"M", "timezone"=>"Europe/Paris", "company"=>"Grabou Corp", "landline"=>nil, "mobile"=>nil, "skypeId"=>nil, "isPresent"=>true, "status"=>"present", "isClient"=>false, "assisted"=>nil, "isAssistant"=>nil, "isThreadOwner"=>false}, {"account_email"=>nil, "accountEmail"=>nil, "email"=>"babtou@fragile.fr", "fullName"=>"Babtou Fragile", "firstName"=>"Babtou", "lastName"=>"Fragile", "usageName"=>"Monsieur Babtou Fragile", "gender"=>"M", "timezone"=>"Europe/Paris", "company"=>"Babtou Corp", "landline"=>nil, "mobile"=>nil, "skypeId"=>nil, "isPresent"=>true, "status"=>"present", "isClient"=>false, "assisted"=>nil, "isAssistant"=>nil, "isThreadOwner"=>false}], :appointment_in_email=>{:en=>"a meeting", :fr=>"un rendez-vous"}, :location_in_email=>{:en=>"", :fr=>""}, :should_ask_location=>false, :missing_contact_info=>nil, :date=>"2018-03-13T14:30:00+00:00"}
