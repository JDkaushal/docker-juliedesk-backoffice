...
ActiveRecord::Schema.define(version: 20180417154244) do
  ...
  add_index "messages_threads", ["in_inbox"], name: "index_messages_threads_on_in_inbox", using: :btree
  add_index "messages_threads", ["should_follow_up"], name: "index_messages_threads_on_should_follow_up", using: :btree
