...
describe AutomaticProcessing::AutomatedMessageClassification do
  ...
  describe 'process_message_id' do
    ...
    it 'should create the correct MessageClassification' do
      ...
      allow(MessagesThread).to receive(:contacts).and_return([])
      ...
      expect(last_message_classif.summary).to eq("Mtg ")
      ...
      expect(last_message_classif.attendees).to eq("[]")
      ...
      expect(last_message_classif.attendees_emails).to eq([])
    end
  end
end