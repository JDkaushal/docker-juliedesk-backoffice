...
describe Api::V1::MessagesThreadsController, :type => :controller do
  ...
  describe 'inbox_count' do
    ...
    it 'should return 0 messages threads count when no threads in inbox' do
      ...
      expect(response.body).to eq("{\"status\":\"success\",\"data\":{\"count\":0,\"admin_count\":0,\"global_productivity\":0,\"individual_productivity\":null,\"current_delay\":0,\"priority_count\":0,\"follow_up_messages_threads_priority\":0,\"follow_up_messages_threads_main\":0}}")
    end
    ...
    it 'should return the messages threads for admin count when there are threads in inbox that are not delegated to founders and no accounts are retrieved from the redis accounts cache ' do
      ...
      expect(response.body).to eq("{\"status\":\"success\",\"data\":{\"count\":0,\"admin_count\":5,\"global_productivity\":0,\"individual_productivity\":null,\"current_delay\":0,\"priority_count\":0,\"follow_up_messages_threads_priority\":0,\"follow_up_messages_threads_main\":0}}")
    end
    ...
    it 'should return the correct messages threads count when there are threads in inbox that have an account found in the cache' do
      ...
      expect(response.body).to eq("{\"status\":\"success\",\"data\":{\"count\":5,\"admin_count\":0,\"global_productivity\":0,\"individual_productivity\":null,\"current_delay\":0,\"priority_count\":0,\"follow_up_messages_threads_priority\":0,\"follow_up_messages_threads_main\":0}}")
    end
    ...
    it 'should return the correct messages threads count when there are threads in inbox that have an account found in the cache but some have companies working hours out of bounds' do
      ...
      expect(response.body).to eq("{\"status\":\"success\",\"data\":{\"count\":3,\"admin_count\":0,\"global_productivity\":0,\"individual_productivity\":null,\"current_delay\":0,\"priority_count\":0,\"follow_up_messages_threads_priority\":0,\"follow_up_messages_threads_main\":0}}")
    end
  end
