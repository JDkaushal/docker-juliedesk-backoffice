class NotesManager {
    ...
    static get PARTS() {
        ...
        parts[this.EMAIL_HISTORY_PART] = {
            ...
            'title': {
                [NotesManager.LANG_FR]: 'Conversation',
                [NotesManager.LANG_EN]: 'Thread'
            },
            // TODO: remove (retro-compatibility)
        ...
        parts[this.CUSTOMER_NOTES_PART] = {
            ...
            /*'title': {
                [NotesManager.LANG_FR]: 'Votre-contenu',
                [NotesManager.LANG_EN]: 'Your content'
            },*/
            // TODO: remove (retro-compatibility)
    ...
    static getNotesManager(content, textContent) {
       ...
       if($html.find('.' + NotesManager.JULIEDESK_NOTES_CLASS_NAME).size() == 0) {
           ...
           let customerContent = content.replace(/\[JULIE\-DESK\](.*)\[\/JULIE\-DESK\]/, '');
        ...
        /*const selector = '.' + this.JULIEDESK_NOTES_CLASS_NAME;
    ...
    constructor(content, options) {
        ...
        if(this.contentType == NotesManager.TYPE_HTML) {
            //this.$html.html($('<textarea />').html(content).text());
            this.$html = $(content);
        }
        ...
        if(this.contentType == NotesManager.TYPE_HTML) {
            ...
            this.loadEmailHistoryAsText();
            this.loadCustomerNotesAsText();
        }
    ...
    updateJulieDeskNotes() {
        ...
        $notesNode.append("<p>[JULIE-DESK]</p>");
        for(let partName of NotesManager.JULIEDESK_NOTES_PARTS) {
    ...
    updateEmailHistory() {
        ...
        this.$html.append("<p>[JULIE-DESK]</p>", this.generateEmailHistoryHTML(), "<p>[/JULIE-DESK]</p>");
        return this.$html;
    }
