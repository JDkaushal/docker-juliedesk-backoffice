  ...
  describe 'trigger' do
    ...
    it 'should trigger the correct actions' do
      ...
      expect(flow).to receive(:get_invitations_sent_template).with(
          {
              :client_names=>["Monsieur Thread Owner"],
              ...
              :attendees=>[
                  {
                      ...
                      "firstName"=>"Thread",
                      "lastName"=>"Owner",
                      "usageName"=>"Monsieur Thread Owner",
                      "gender"=>"M",
                      "company"=>"Owner Corp",
                      "landline"=>nil,
                      "mobile"=>nil,
                  ...
                  },
                  {
                      "account_email"=>nil,
                      "email"=>"john.bernard@grabou.fr",
                      "fullName"=>"John Bernard",
                      "firstName"=>"John",
                      "lastName"=>"Bernard",
                      "usageName"=>"Monsieur John Bernard",
                      "gender"=>"M",
                      "company"=>"Grabou Corp",
                      "landline"=>nil,
                      "mobile"=>nil,
                  ...
                  },
                  {
                      "account_email"=>nil,
                      "email"=>"babtou@fragile.fr",
                      "fullName"=>"Babtou Fragile",
                      "firstName"=>"Babtou",
                      "lastName"=>"Fragile",
                      "usageName"=>"Monsieur Babtou Fragile",
                      "gender"=>"M",
                      "company"=>"Babtou Corp",
                      "landline"=>nil,
                      "mobile"=>nil,
              ...
              :date=>"2018-03-13T14:30:00+00:00"
          }
      ).and_return('mocked_generated_template')

      expect(flow).to receive(:create_event).with({
                                                      :email=>"stagingjuliedesk@gmail.com",
                                                      :summary=>"Mtg Owner Corp [Thread Owner] <> Grabou Corp [John Bernard] <> Babtou Corp [Babtou Fragile]",
                                                      :description=>"<b>Organizer infos</b><br/>Fred Grais<br/><br/><br/><br/>\n",
                                                      :attendees=> [
                                                          {
                                                              "account_email"=>nil,
                                                              "email"=>"threadowner@owner.fr",
                                                      ...
                                                      :location=>"15bis Boulevard Saint-Denis, 75002 Paris, France",
                                                      :all_day=>false,
                                                      :private=>false,
                                                      :start=>"2018-03-13T14:30:00+00:00",
                                                      :end=>"2018-03-13T15:30:00+00:00",
                                                      :start_timezone=>"Europe/Paris",
                                                      :end_timezone=>"Europe/Paris",
                                                      :calendar_login_username=>"stagingjuliedesk@gmail.com",
                                                      :meeting_room=>{
                                                          :used=>true,
                                                          :booked_rooms=>["room1@email.com", "room2@email.com"]
                                                      },
