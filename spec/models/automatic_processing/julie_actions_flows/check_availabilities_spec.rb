  ...
  describe 'trigger' do
    ...
    it 'should trigger the correct actions' do
      ...
      expect(flow).to receive(:get_invitations_sent_template).with(
          {:client_names=>["Monsieur Thread Owner"], :timezones=>["Europe/Paris"], :locale=>"en", :is_virtual=>false, :attendees=>[{:name=>"Monsieur Thread Owner", :assisted_by_name=>"Julie", :email=>"threadowner@owner.fr"}, {:name=>"Monsieur John Bernard", :assisted_by_name=>nil, :email=>"john.bernard@grabou.fr"}, {:name=>"Monsieur Babtou Fragile", :assisted_by_name=>nil, :email=>"babtou@fragile.fr"}], :appointment_in_email=>{:en=>"a meeting", :fr=>"un rendez-vous"}, :location_in_email=>{:en=>"", :fr=>""}, :location=>"15bis Boulevard Saint-Denis, 75002 Paris, France", :location_is_settled=>true, :should_ask_location=>false, :missing_contact_info=> "mobile", :date=>"2018-03-13T14:30:00+00:00"}
