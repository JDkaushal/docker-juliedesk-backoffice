...
describe AutomaticProcessing::JulieActionsFlows::SendConfirmation do
  ...
  subject(:flow) { AutomaticProcessing::JulieActionsFlows::SendConfirmation.new(julie_action) }
  ...
  describe 'trigger' do
    ...
    it 'should trigger the right actions' do
      ...
      expect(flow).to receive(:get_send_confirmation_template).with(
          {:locale=>"en"}
      ...
      expect(flow).to receive(:update_event).with({:event_id=>nil, :email=>"stagingjuliedesk@gmail.com", :summary=>"Mtg Owner Corp [Thread Owner] <> Grabou Corp [John Bernard] <> Babtou Corp [Babtou Fragile]", :description=>"<b>Organizer infos</b><br/>Fred Grais<br/><br/><br/><br/>\n<br/><br/><b>Contacts infos</b><br/>Thread Owner<br/>Mobile: +33102030405<br/><br/><br/>\n", :attendees=>[{"account_email"=>"threadOwner@owner.fr", "accountEmail"=>"threadOwner@owner.fr", "email"=>"threadowner@owner.fr", "fullName"=>"Thread Owner", "firstName"=>"Thread", "lastName"=>"Owner", "usageName"=>"Monsieur Thread Owner", "gender"=>"M", "timezone"=>"Europe/Paris", "company"=>"Owner Corp", "landline"=>"", "mobile"=>"+33102030405", "skypeId"=>"", "confCallInstructions"=>"", "isPresent"=>true, "status"=>"present", "isClient"=>true, "assisted"=>nil, "isAssistant"=>nil, "isThreadOwner"=>false}, {"account_email"=>nil, "accountEmail"=>nil, "email"=>"john.bernard@grabou.fr", "fullName"=>"John Bernard", "firstName"=>"John", "lastName"=>"Bernard", "usageName"=>"Monsieur John Bernard", "gender"=>"M", "timezone"=>"Europe/Paris", "company"=>"Grabou Corp", "landline"=>nil, "mobile"=>nil, "skypeId"=>nil, "confCallInstructions"=>nil, "isPresent"=>true, "status"=>"present", "isClient"=>false, "assisted"=>nil, "isAssistant"=>nil, "isThreadOwner"=>false}, {"account_email"=>nil, "accountEmail"=>nil, "email"=>"babtou@fragile.fr", "fullName"=>"Babtou Fragile", "firstName"=>"Babtou", "lastName"=>"Fragile", "usageName"=>"Monsieur Babtou Fragile", "gender"=>"M", "timezone"=>"Europe/Paris", "company"=>"Babtou Corp", "landline"=>nil, "mobile"=>nil, "skypeId"=>nil, "confCallInstructions"=>nil, "isPresent"=>true, "status"=>"present", "isClient"=>false, "assisted"=>nil, "isAssistant"=>nil, "isThreadOwner"=>false}], :location=>"15bis Boulevard Saint-Denis, 75002 Paris, France", :all_day=>false, :private=>false, :start=>"2018-04-03 16:15:00 +0200", :end=>"2018-04-03 17:15:00 +0200", :start_timezone=>"Europe/Paris", :end_timezone=>"Europe/Paris", :calendar_login_username=>"calendar_login_username", :meeting_room=>{:used=>true, :booked_rooms=>[{:summary=>"Summary room 1", :id=>"room1@email.com", :location=>"Location room 1"}, {:summary=>"Summary room 2", :id=>"room2@email.com", :location=>"Location room 2"}]}, :create_skype_for_business_meeting=>false})
